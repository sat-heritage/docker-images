...
<p>SAT solvers from the first competitions to Knuth's programs, each as a binary ready to run, with the most thorough traceability we can offer: original sources, dated build environment, recipe and verification, all reproducible.</p></header>
