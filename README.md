...
| binary_only | boolean | true when the submission itself contains no source, only a compiled artifact that the image ships as is; the website then labels the image "binary only" |
